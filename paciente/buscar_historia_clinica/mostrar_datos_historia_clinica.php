...
<title>Mostrar Historia Clínica</title>
...
<form action="historia_clinica_actualizada.php" method="post" class="form-register">
    ...
    <input type="hidden" name="txtcedula" value="<?php echo"".$cedula."";?>">
     ...
     <h3 class="input-30">Antecedentes Patológicos</h3>
           <textarea name="txareapatologicos" class="input-100" rows="10" cols="40" wrap="soft" placeholder="Antecedentes Patológicos"  required readonly="readonly"><?php echo"".$antecedentes."";?></textarea>
    

     <h3 class="input-30">Observaciones</h3>
<textarea name="txareaobservaciones" class="input-100" rows="10" cols="40" wrap="soft" placeholder="Observaciones" required readonly="readonly"><?php echo"".$observaciones."";?></textarea>    
